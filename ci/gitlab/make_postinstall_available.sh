...
status=$(curl --location --header "PRIVATE-TOKEN: ${TMP_PROJECT_PAT:-none}" "https://gitlab.inria.fr/api/v4/projects/5283/jobs/artifacts/${branch}/download?job=build" --output postinstall.zip --write-out "%{http_code}")
